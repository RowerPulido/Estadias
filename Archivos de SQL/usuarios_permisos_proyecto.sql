...
grant select on schema :: Usuario to user_tutor;
...
grant execute on schema :: Alumno to user_tutor;
grant execute on schema :: Calificacion to user_tutor;
grant execute on schema :: Usuario to user_tutor;
grant execute on schema :: Estadia to user_tutor;
grant execute on schema :: Documento to user_tutor;
...
grant select on schema :: Usuario to user_alumno;
