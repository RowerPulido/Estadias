...
$connection->close();
echo '{ "status" : 0 , "matricula" : '.$matricula.' , "descripcion" : "succesful" }';



  $connection1= new SqlServerConnection();
  $query1=sprintf("SELECT * FROM getInfoEst('".$matricula."');");
  $data=$connection1->execute_query($query);
